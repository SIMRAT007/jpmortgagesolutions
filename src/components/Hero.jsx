...
const Hero = forwardRef((props, ref) => {
  ...
  return (
    <section ref={ref} id="hero" className="min-h-screen flex flex-col bg-gradient-to-br from-[#152945] via-[#152945] to-[#E7CD87] text-white relative overflow-hidden pt-26 md:pt-20">
      {/* Background Pattern */}
