    ...
    <section ref={ref} id="hero" className="min-h-screen flex flex-col bg-gradient-to-br from-[#152945] via-[#152945] to-[#E7CD87] text-white relative overflow-hidden pt-26 md:pt-0">
      ...
      <div className="flex-1 flex items-center justify-between px-8 lg:px-16 xl:px-24 relative z-10">
        ...
        <div className="flex-1 max-w-3xl md:mt-30 mt-2">
          <div className="inline-block bg-[#E7CD87] text-[#152945] px-4 py-2 rounded-full text-sm font-semibold mb-6">
          ...
          <p className="text-xl lg:text-2xl text-[#EDE8D1] mb-8 leading-relaxed max-w-2xl">
        ...
        <div className="hidden lg:flex flex-1 justify-center items-center md:mt-30">
